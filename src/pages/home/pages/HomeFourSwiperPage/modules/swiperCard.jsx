...
export default function SwiperCard({ title, description, image, onCardClick }) {
  ...
  return (
    <div className="swiper-card  relative p-2 md:p-6 rounded-3xl shadow-xl overflow-hidden bg-gradient-to-t from-gray-800 via-gray-600 to-gray-400 text-white">
      ...
      <div className="relative z-10 " >
        {/* Заголовок карточки */}
        <h3 className=" text-2xl text-center mt-2   md:text-4xl xl:h-[100px]   font-extrabold  mb-4 text-shadow-xl leading-tight">{title}</h3>
